...
export class Message extends Model {
    ...
    getViewElement(me = true) {
                    ...
                    <div class="_3_7SH _1ZPgd">
                        <div class="_1fnMt _2CORf">
                            ...
                            <div class="_3cMIj">
                                ...
                                <span class="PyPig message-file-type">${this.fileType.split('/')[1].toUpperCase()}</span>
                                <span class="PyPig message-file-size">${Format.bytesToSize(this.size)}</span>
                            </div>
                            <div class="_3Lj_s">
                                <div class="_1DZAH" role="button">
                                    <span class="message-time">${Format.timeStampToTime(this.timeStamp)}</span>
        ...
        div.firstElementChild.classList.add(className); // Estarei colocando no Primeiro elemento Filho em forama de lista, o Recebimento||Envio da menssagem com className
    ...
    static sendContact(chatId, from, contact){
        ...
        return Message.send(chatId, from, 'contacts', contact);
